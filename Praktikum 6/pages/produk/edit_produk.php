 ...
 <div class="container">
    ...
    <form method="POST" action="../../process/produk/proses_produk.php">
        ...
        <div class="form-group">
            ...
            <input id="nama" name="nama" type="text" class="form-control" value="<?= $result['kode']?>" required>
        </div>
        <div class="form-group">
            <label for="harga_beli" class="form-label">Harga Beli</label>
            <input id="harga_beli" name="harga_beli" value="<?= $result['kode']?>" required type="text" class="form-control">
        </div>
        <div class="form-group">
